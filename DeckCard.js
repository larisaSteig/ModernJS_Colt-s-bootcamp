...
//Defactoring the decks and making it in multiple way
...
//create one deck
const deckOne = makeDeck();
deckOne.originalDeck();
deckOne.shuffle();
const h1 = deckOne.drawMultipleCard(2);
const h2 = deckOne.drawnCard();
const h3  = deckOne.drawMultipleCard(3);
